...
<body>
    ...
    <div style="text-align: center; margin-top: 150px;">
        <div class="card" style="width: 18rem; display: inline-block; margin: 10px;">
            <img src="resimlerr/bu.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Otobüsler</h5>
                <p class="card-text">Kocaeli otobüs hatlarına buradan ulaşabilirsiniz.</p>
                <a href="otobus.php" class="btn btn-primary">Git</a>
            </div>
        </div>
        <div class="card" style="width: 21rem; display: inline-block; margin: 10px;">
            <img src="resimlerr/travmaay2.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Tramvay</h5>
                <p class="card-text">Kocaeli tramvay hatlarına buradan ulaşabilirsiniz.</p>
                <a href="tramvay.php" class="btn btn-primary">Git</a>
            </div>
        </div>
        <div class="card" style="width: 17rem; display: inline-block; margin: 10px;">
            <img src="resimlerr/vapur.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Vapur</h5>
                <p class="card-text">Kocaeli vapur hatlarına buradan ulaşabilirsiniz.</p>
                <a href="vapur.php" class="btn btn-primary">Git</a>
            </div>
        </div>
    </div>
