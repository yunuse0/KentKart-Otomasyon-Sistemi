...
<head>
    ...
    <style>
        ...
        body {
            background-image: url('https://r.resimlink.com/LodvHaP0zw79.jpg');
        ...
        .container {
            text-align: center; /* Fotoğrafları merkezlemek için */
        }
        .dropdown-container {
            position: relative;
            display: flex;
...
<body>
    ...
    <div class="dropdown-container">
        ...
        <div class="dropdown-content" style="font-size: 16px; font-family:'Times New Roman', Times, serif">
            <a href="https://www.ulasimburada.com/kocaeli/route/T1/direction/1" target="_blank">Hat T1 (OTOGAR - KURUÇEŞME)</a>
            <a href="#">Hat T3 (MEHMET ALİ PAŞA - ŞEHİR HASTANESİ) </a>
        </div>
    </div>
